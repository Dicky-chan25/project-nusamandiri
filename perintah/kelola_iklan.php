...
if($aksi=="tambah")
{
$simpan=mysqli_query($koneksi,"insert into iklan(nm_perusahaan,email,link,gambar,isi_iklan,tgl_mulai,tgl_akhir,hargasewa,lamasewa, totalharga, aktif,id_admin) values('$nm_perusahaan','$email','$link','$gambar','$teks_iklan','$tgl_mulai','$tgl_akhir','$hargas ewa','$lamasewa','$totalharga','0','$id_admin')");
