...
$iklan=mysqli_fetch_array(mysqli_query("select * FROM iklan WHERE id_iklan='$id_iklan'"));
?>
<h2> Edit Iklan</h2>
...
<table width="50%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>Harga Sewa</td>
    <td><input type="text" name="hargasewa" required value="<?php echo $iklan['hargasewa']; ?>" ></td>
  </tr>
